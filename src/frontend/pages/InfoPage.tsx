  ...
  return (
    <main className="w-full h-full bg-green/50">
      <section className="max-w-4xl mx-auto w-full py-10 px-6 h-full bg-ligth">
        ...
        <p className="mb-4 text-lg">
          The platform is designed with a user-friendly interface and clean
          layout to help readers organize their reading life with ease.
        </p>

        <p className="mb-4 text-lg">
          <strong>Data Source:</strong> All book information is retrieved from
          the{" "}
